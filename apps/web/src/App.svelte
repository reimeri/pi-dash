        ...
        {:else if startup.status === "unauthorized"}
          <Empty.Root class="mx-auto h-full max-w-lg">
            <Empty.Header>
              ...
              >
              <Empty.Description
                >Return to the terminal running Pi Dash and open the one-time
                URL it printed.</Empty.Description
              >
            </Empty.Header>
          </Empty.Root>
          ...
          >
            ...
            <Card.Root>
              <Card.Header>
                ...
                <Card.Action>
                  <Badge
                    variant={selectedWorkspace.repository.health === "healthy"
                      ? "secondary"
                      : "destructive"}
                  >
                      ...
                      <Card.Footer class="flex-wrap gap-2">
                        {#if worktree.lifecycle === "ready"}
                          ...
                          <Button
                            variant="destructive"
                            class="ml-auto"
                            onclick={() => (removeWorktreeTarget = worktree)}
                          >
                            <HugeiconsIcon
                              icon={Delete02Icon}
                              strokeWidth={2}
