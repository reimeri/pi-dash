...
| Replay buffer bytes          | `--terminal-output-buffer-bytes`       | `PI_DASH_TERMINAL_OUTPUT_BUFFER_BYTES`       | `terminalOutputBufferBytes`      | `4194304`                                       |
